    ...
    return (
      <div className="bg-white p-3 border border-slate-100 shadow-xl rounded-lg">
        ...
        <p className="text-indigo-600 text-sm">
          Spend: {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(payload[0].value)}
        </p>
      </div>
    );
  }
...
export const SpendDistributionChart: React.FC<ChartProps> = ({ data }) => {
  return (
              ...
              return (
                <div className="bg-white p-3 border border-slate-100 shadow-xl rounded-lg">
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <p className="text-slate-600 flex justify-between gap-4"><span>Revenue:</span> <span className="font-bold text-emerald-600">${d.revenue.toLocaleString()}</span></p>
                  </div>
                </div>
              );
            }
